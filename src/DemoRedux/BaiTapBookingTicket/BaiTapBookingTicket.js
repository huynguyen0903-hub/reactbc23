    ...
    <div style={{position:'fixed',width:'100%',height:'100%',backgroundColor:'rgba(0,0,0,0.7)'}}></div>
       ...
       <div className='row'>
            <div className='col-8 text-center'>
                <div className=' display-4 text-warning'>ĐẶT VÉ XEM PHIM CYBERLEARN.VN</div>
            ...
            <div className='col-4 '>
            <div style={{fontSize:'35px'}} className=' text-light mt-2'>DANH SÁCH GHẾ BẠN CHỌN</div>
              <ThongTinDatGhe/>
            </div>
        </div>
       </div>
